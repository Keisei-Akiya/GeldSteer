...
pub async fn find_categories_by_account(
    pool: &DbPool,
    account_id: &str,
...
pub async fn find_category_by_id(pool: &DbPool, id: &str) -> AppResult<Option<AssetCategory>> {
...
pub async fn update_category(
    pool: &DbPool,
    id: &str,
    account_id: &str, // Ensure ownership
    name: String,
    target_ratio: Decimal,
) -> AppResult<AssetCategory> {
...
pub async fn create_grouping(
    ...
    find_grouping_by_id(pool, id)
        .await?
        .ok_or_else(|| AppError::NotFound("Created grouping not found".into()))
}

pub async fn find_groupings_by_account(
    pool: &DbPool,
    account_id: &str,
...
pub async fn find_grouping_by_id(pool: &DbPool, id: &str) -> AppResult<Option<UserAssetGrouping>> {
...
pub async fn find_assets_by_account(pool: &DbPool, account_id: &str) -> AppResult<Vec<Asset>> {
...
pub async fn find_asset_by_id(pool: &DbPool, id: &str) -> AppResult<Option<Asset>> {
